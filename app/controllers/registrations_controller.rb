    ...
    class RegistrationsController < ApplicationController
                    ...
                    html:    "
                        ...
                        <html>
                            <body>
                                ...
                                <p> Thank you for registering at CWA Portal<br>
                                ...
                                <em>-CWA Portal Team</em></p><br><br><br>
        ...
        def resend
            ...
            if @user.save
                ...
                message_params =  { from: 'admin@cwaportal.org',
                    to:   @user.email,
                    #"h:List-Unsubscribe": "<mailto:admin@floridablaze.io?subject=unsubscribe>",
                    #"h:Reply-To": "FlordaBlaze Staff <admin@floridablaze.io>",
                    subject: 'Welcome to CWA Portal',
                    html:    "
        ...
        def forgot
            ...
            if @user.present?
                ...
                if Rails.env.production?
                    host = "https://cwaportal.herokuapp.com"
                else
                    host = "127.0.0.1:3000"
                end
                ...
                email = SendGrid::Mail.new
                email.from = Email.new(email: 'admin@Fcwaportal.org', name: "CWA Portal Team")
                
                email.subject = "** CWAPortal password reset **"
